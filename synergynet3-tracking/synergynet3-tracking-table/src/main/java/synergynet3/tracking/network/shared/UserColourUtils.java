...
public class UserColourUtils {
	...
	private static final Color[] COLOURS = { Color.RED, Color.BLUE, Color.CYAN,
			Color.GREEN, Color.MAGENTA, Color.PINK, Color.YELLOW,
			new Color(0, 100, 0), new Color(139, 0, 204), new Color(255, 90, 0) };
