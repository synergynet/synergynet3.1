...
public class PointDirection implements Serializable
{
	...
	/**
	 * @param x
	 *            the x value of the end point to set
	 * @param y
	 *            the y value of the end point to set
	 * @param z
	 *            the z value of the end point to set
	 */
	...
	/**
	 * @param x
	 *            the x value of the start point to set
	 * @param y
	 *            the y value of the start point to set
	 * @param z
	 *            the z value of the start point to set
	 */
