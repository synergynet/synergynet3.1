/*
 * GraphicsGems.java Created on September 9, 2004, 11:21 PM
 */
...
public class GraphicsGems
{
	...
	/*
	 * Roots3And4.c Utility functions to find cubic and quartic roots,
	 * coefficients are passed like this: c[0] + c[1]*x + c[2]*x^2 + c[3]*x^3 +
	 * c[4]*x^4 = 0 The functions return the number of non-complex roots and put
	 * the values into the s array. Author: Jochen Schwarze (schwarze@isa.de)
