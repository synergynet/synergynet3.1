...
public class POIManager {
	...
	public void generateLensButton() throws ContentTypeNotBoundException{
		...
		lensButton.setText(MuseumAppPreferences.getLensButtonText(), MuseumAppPreferences.getLensButtonBackgroundColour(), 
				MuseumAppPreferences.getLensButtonBorderColour(), MuseumAppPreferences.getLensButtonFontColour(), 150, 60, stage);
