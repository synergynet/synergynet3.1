...
public class ShutdownGUI implements KeyboardOutput{
	...
	public ShutdownGUI(final IStage stage, float displayWidth, float displayHeight, float buttonWidth, float textScale, final String code) throws ContentTypeNotBoundException{
		...
		keypad.setColours(INVISIBLE, MuseumAppPreferences.getShutdownControlsBackgroundColour(), 
				MuseumAppPreferences.getShutdownControlsBorderColour(), INVISIBLE, MuseumAppPreferences.getShutdownControlsFontColour());
	...
	private IButtonbox generateTextbox(IStage stage) throws ContentTypeNotBoundException{ 
		...
		textBox.setText("", MuseumAppPreferences.getShutdownControlsBackgroundColour(), 
				MuseumAppPreferences.getShutdownControlsBorderColour(), MuseumAppPreferences.getShutdownControlsFontColour(), WIDTH/2, 60, stage);
	...
	private IButtonbox generateOkButton(String text, float buttonWidth, float buttonHeight, IStage stage) throws ContentTypeNotBoundException{
		...
		okButton.setText(text, MuseumAppPreferences.getShutdownControlsBackgroundColour(), 
				MuseumAppPreferences.getShutdownControlsBorderColour(), MuseumAppPreferences.getShutdownControlsFontColour(), buttonWidth - 20, 60, stage);
		okButton.setVisible(false);
		stage.addItem(okButton);
		return okButton;
	}
