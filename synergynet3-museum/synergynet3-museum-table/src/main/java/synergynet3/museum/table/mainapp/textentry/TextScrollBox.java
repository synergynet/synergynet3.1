...
public class TextScrollBox {
	 ...
	 */
	public TextScrollBox(IStage stage, float width, float height,
			float gapSize, float textScale) throws ContentTypeNotBoundException {
		textLabel = stage.getContentFactory().create(ITextbox.class,
