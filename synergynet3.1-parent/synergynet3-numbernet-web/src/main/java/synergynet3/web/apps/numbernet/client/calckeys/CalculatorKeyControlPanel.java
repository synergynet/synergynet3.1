	...
	public CalculatorKeyControlPanel() {
		...
		chckbxPlus.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.PLUS, chckbxPlus.getValue());
			}
		});
		...
		chckbxMinus.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.MINUS, chckbxMinus.getValue());
			}
		});
		...
		chckbxMultiply.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.MULTIPLY, chckbxMultiply.getValue());
			}
		});
		...
		chckbxDivide.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.DIVIDE, chckbxDivide.getValue());
			}
		});
		...
		chckbxSeven.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.SEVEN, chckbxSeven.getValue());
			}
		});
		...
		chckbxEight.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.EIGHT, chckbxEight.getValue());
			}
		});
		...
		chckbxNine.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.NINE, chckbxNine.getValue());
			}
		});
		...
		chckbxFour.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.FOUR, chckbxFour.getValue());
			}
		});
		...
		chckbxFive.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.FIVE, chckbxFive.getValue());
			}
		});
		...
		chckbxSix.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.SIX, chckbxSix.getValue());
			}
		});
		...
		chckbxLeftBracket.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.LEFTBRACKET, chckbxLeftBracket.getValue());
			}
		});
		...
		chckbxOne.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.ONE, chckbxOne.getValue());
			}
		});
		...
		chckbxTwo.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.TWO, chckbxTwo.getValue());
			}
		});
		...
		chckbxThree.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.THREE, chckbxThree.getValue());
			}
		});
		...
		chckbxRightBracket.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.RIGHTBRACKET, chckbxRightBracket.getValue());
			}
		});
		...
		chckbxZero.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.ZERO, chckbxZero.getValue());
			}
		});
		...
		chckbxDot.addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if(delegate != null) delegate.keyStateChanged(CalculatorKey.POINT, chckbxDot.getValue());
			}
		});
