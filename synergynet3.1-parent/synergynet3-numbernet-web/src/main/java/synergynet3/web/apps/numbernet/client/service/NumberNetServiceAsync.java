...
public interface NumberNetServiceAsync {
	 ...
	 */
	void getExpressionsForTable(String table,
			AsyncCallback<List<Expression>> callback);
	 ...
	 */
	void getNamesForTable(String table,
	 ...
	 * @param callback the callback
	 */
	void rotateTableContentAndTargets(List<TableTarget> to,
			AsyncCallback<Void> callback);
	 ...
	 *
	 * @param graphingModeOn the graphing mode on
	 * @param callback the callback
	 */
	 ...
	 * @param callback the callback
	 */
	void updatePositionInformationFromProjector(String projector,
			AsyncCallback<Void> callback);
}
