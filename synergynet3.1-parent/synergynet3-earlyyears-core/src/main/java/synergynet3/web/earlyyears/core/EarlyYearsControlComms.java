...
public class EarlyYearsControlComms
{
	 ...
	 *
	 * @param show
	 *            the new all tables explorer show teacher control
	 */
	 ...
	 *
	 * @param newNum
	 *            the new all tables railway corners
	 */
	 ...
	 *
	 * @param newNum
	 *            the new all tables railway crosses
	 */
	 ...
	 *
	 * @param newNum
	 *            the new all tables railway straights
	 */
