...
public class SynergyNetPosition extends PerformActionMessage implements Serializable {
	...
	/**
	 * Create a structured device position message for transmission through the cluster. 
	 * This message is used to initialise the creation of a virtual device representation.
	 * 
	...
	/**
	 * Create a structured device position message for transmission through the cluster. 
	 * This message is used to initialise the removal of a virtual device representation.
	 * 
	 * @param tableIdentity
	 * @param remove
	 */
	 ...
	 * 
	 * @return Float representing the X value of the device interface's location.
	 */
	 ...
	 * 
	 * @return Float representing the Y value of the device interface's location.
	 */
	 ...
	 * 
	 * @return Float representing the height from the floor of the device interface.
	 */
	 ...
	 * 
	 * @param height The height from the floor of the device interface represented.
	 */
	 ...
	 * 
	 * @return Float representing the pixel width of the interface represented in pixels.
	 */
