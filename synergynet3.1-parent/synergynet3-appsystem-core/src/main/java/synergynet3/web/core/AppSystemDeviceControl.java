...
public class AppSystemDeviceControl extends ClusteredDevice {
	...
	/** Network messages instigating the recreation of items from a device's directory in the networked shared cache. */
	private DistributedProperty<PerformActionMessage> reloadServerContentsControl;
	
	/** Network messages instigating the recreation of items from a removable drive.  */
	private DistributedProperty<PerformActionMessage> reloadRemovableDriveContentsControl;
	
	/** Network messages instigating bringing student icons to the top of an environment. */
	...
	/** Network messages instigating the removal of any items in an environment not directly created by the application. */
	private DistributedProperty<PerformActionMessage> removeAdditionalMediaControl;
	
	/** Network messages announcing the location of another device's interface position. */
	private DistributedProperty<SynergyNetPosition> tablePositionsControl;
	
	/** Network messages announcing the arrival of an item transferred through a network flick. */
	...
	/** Network messages relating to the value to be used when converting between pixels and metres. */
	 ...
	 * 
	 * @param deviceName ID of the device being initiated on the network cluster.
	 */
	...
	/**
	 * Initialises the corresponding shared properties with the supplied default value.
	 * 
	 * @param control Property on the network cluster to be initialised.
	 * @param defaultValue The default value to be used when initialising the shared property.
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages relating to students being logged in.
	 * 
	 * @return The value  of the network cluster property representing messages relating to students being logged in.
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages relating to students being logged out. 
	 * 
	 * @return The value  of the network cluster property representing messages relating to students being logged out. 
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages relating to a class being logged out. 
	 * 
	 * @return The value  of the network cluster property representing messages relating to a class being logged out.
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages instigating the recreation of items 
	 * from a device's directory in the networked shared cache. 
	 * 
	 * @return The value  of the network cluster property representing 
	 * messages instigating the recreation of items from a device's directory in the networked shared cache.
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages instigating the recreation of items from a removable drive. 
	 * 
	 * @return The value  of the network cluster property representing messages instigating the recreation of items from a removable drive.
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages instigating bringing student icons to the top of an environment. 
	 * 
	 * @return The value  of the network cluster property representing messages instigating bringing student icons to the top of an environment 
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages instigating the creation of a screenshot item. 
	 * 
	 * @return The value of the network cluster property representing messages instigating the creation of a screenshot item. 
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages instigating the 
	 * removal of any items in an environment not directly created by the application.  
	 * 
	 * @return The value of the network cluster property representing messages 
	 * instigating the removal of any items in an environment not directly created by the application. 
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages announcing the location of another device's interface position. 
	 * 
	 * @return The value of the network cluster property representing messages announcing the location of another device's interface position. 
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages announcing the arrival of an item transferred through a network flick.
	 * 
	 * @return The value of the network cluster property representing messages announcing the arrival of an item transferred through a network flick. 
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages announcing whether network flicks are enabled for this device.
	 * 
	 * @return The value of the network cluster property representing messages announcing whether network flicks are enabled for this device.
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages initiating tables sending screenshots to projectors.
	 * 
	 * @return The value of the network cluster property representing messages initiating tables sending screenshots to projectors.
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages initiating tables sending contents to projectors.
	 * 
	 * @return The value of the network cluster property representing messages initiating tables sending contents to projectors.
	 */
	...
	/**
	 * Get the value of the network cluster property representing messages relating content arriving on a table.
	 * 
	 * @return The value of the network cluster property representing messages relating to content arriving on a table.
	 */
	...
	/**
	 * Get the value of the network cluster property representing the value to be used when converting between pixels and metres.
	 * 
	 * @return The value of the network cluster property representing the value to be used when converting between pixels and metres.
	 */
	...
	/**
	 * Get the value of the network cluster property representing the table's freeze state.
	 * 
	 * @return The value of the network cluster property representing the table's freeze state.
	 */
