...
public class AppSystemControlComms
{
	 ...
	 *
	 * @param b
	 *            Indicator for whether student icons should be brought to the
	 ...
	 *
	 * @param b
	 *            Indicator for whether the items from removable drives should
	 *            be recreated.
	 */
	 ...
	 *
	 * @param message
	 *            Indicator for whether the items from a device's directory in
	 *            the networked shared cache should be recreated.
	 */
	 ...
	 *            List of the projectors the contents are to be send to.
	 */
	 ...
	 *
	 * @param projectorsToSendTo
	 *            List of the projectors the screenshots are to be send to.
	 */
	 ...
	 *
	 * @param b
	 *            Indicator for whether the devices should.
	 */
	 ...
	 *
	 * @param b
	 *            Indicator for whether a screenshot item should be created.
	 */
	 ...
	 *
	 * @param remoteTable
	 *            The name of the table the latency is to be tested for.
	 ...
	 *
	 * @param className
	 *            Name of the class being logged out.
	 */
	 ...
	 *
	 * @param b
	 *            Indicator for whether network flick is enabled.
	 * @param table
	 *            ID on the network cluster of the device the message is to be
	 *            sent to.
	 */
