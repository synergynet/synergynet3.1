...
/** Class which manages the colours and their corresponding RGB values when referred to on the web pages. */
public class ColourManager {
	
	/** Collection of colour names. */
	private static String[] colours = {"white", "red", "blue", "yellow", "green", "orange", "purple", "pink", "cyan"};
	
	/** Collection of colour RGB values. */
	private static float[][] colourRGBs = {{1f,1f,1f}, {1f,0f,0f}, {0f,0f,1f}, {1f,1f,0f}, {0f,1f,0f}, {1f,69f/255f,0f}, {95f/255f,0f,1f}, {1f, 0f, 1f}, {0f, 1f, 1f}};
