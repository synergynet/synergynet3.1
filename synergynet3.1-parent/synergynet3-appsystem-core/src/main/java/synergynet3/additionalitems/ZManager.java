...
public class ZManager {
	...
	public static void bringFamilyToFront(IItem stage, final IItem item) {
		...
		if (FeedbackSystem.isItemFeedbackContainer(item)) {
			item.getZOrderManager().bringToTop(
	 ...
	 */
	public static void manageLineOrder(IStage stage, ILine line,
			final IItem source, final IItem target, boolean invert) {
	 ...
	 * @param target the target
	 */
	public static void manageLineOrderFull(IStage stage, ILine line,
			final IItem source, final IItem target) {
