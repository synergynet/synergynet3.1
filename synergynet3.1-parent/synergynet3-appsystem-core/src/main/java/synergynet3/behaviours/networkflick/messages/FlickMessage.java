...
public class FlickMessage extends PerformActionMessage implements Serializable {
	 ...
	 * cluster.
	 *
	 * @param targetTableIdentity Target table's identity in the cluster.
	 * @param galleryItem Object representing the flicked item and its attached
	 *            feedback.
	 * @param x The X value of the flicked item's arrival location.
	 * @param y The Y value of the flicked item's arrival location.
	 * @param targetAngle Rotation of the flicked item on arrival.
	 * @param targetScale Scale of the flicked item on arrival.
	 * @param xDir The X value of the flicked item's direction on arrival.
	 * @param yDir The Y value of the flicked item's direction on arrival.
	 * @param flickID The unique ID of the flick message.
	 */
	public FlickMessage(String targetTableID, String sourceTableID,
			GalleryItemDatabaseFormat galleryItem, float x, float y,
			float targetAngle, float targetScale, float xDir, float yDir) {
	 ...
	 *
	 * @param rotation The rotation of the flicked item on arrival.
	 */
	 ...
	 *
	 * @param scale The scale of the flicked item on arrival.
	 */
	 ...
	 *
	 * @param sourceTableID The source table's ID
	 */
	 ...
	 *
	 * @param targetTableID The target table's ID
	 */
