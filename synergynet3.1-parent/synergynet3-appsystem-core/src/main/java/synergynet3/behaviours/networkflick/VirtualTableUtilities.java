...
public class VirtualTableUtilities
{
	 ...
	 *
	 * @param tableID
	 *            ID of the device of the interface represented on the network
	 *            cluster.
	 * @param location
	 *            Location of the interface represented in the physical
	 *            environment relative to the local device's interface position.
	 * @param orientation
	 *            Orientation of the interface represented in the physical
	 *            environment relative to the local device's interface position.
	 * @param dimensions
	 *            The width and height of the device represented's interface.
	 * @param pixelWidth
	 *            The width of the device represented's interface in pixels.
	 */
	public static void addTable(String tableID, Vector2f location, float orientation, Vector2f dimensions, float pixelWidth, float metreWidth, IStage stage)
	{
		...
		Vector2f thisTableLocation = new Vector2f(SynergyNetPositioning.getPixelValue(SynergyNetApp.localDevicePosition.getXinMetres()), SynergyNetPositioning.getPixelValue(SynergyNetApp.localDevicePosition.getYinMetres()));
	 ...
	 *
	 * @param targetTableID
	 *            The ID of the target device on the network cluster.
	 */
	 ...
	 *
	 * @param targetTable
	 *            Spatial representing a remote device interface.
	 ...
	 *
	 * @param tableID
	 *            ID of the device to be removed on the network cluster.
	 */
