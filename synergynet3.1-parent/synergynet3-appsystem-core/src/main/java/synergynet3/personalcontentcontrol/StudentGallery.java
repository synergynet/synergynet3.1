...
public class StudentGallery
{
	...
	public IItem generateGallery(IStage stage)
	{
		if (galleryBox == null)
		{
			...
			try
			{
				...
				galleryBox.addToAllFrames(studentIcon, (galleryBox.getWidth() / 2) - (40 / 2) - 5, (-galleryBox.getHeight() / 2) + (40 / 2) + 5);
			...
			{
				addItemToGalleryContainer(galleryItemsCopy.get(i), stage, (Float) galleryItemsSizesCopy.get(i)[0], (Float) galleryItemsSizesCopy.get(i)[1], (FeedbackContainer) galleryItemsSizesCopy.get(i)[2]);
			}
	 ...
	 *            the new ability to add content from gallery
	 */
	...
	private void addItemToGalleryContainer(IItem item, IStage stage, float width, float height, FeedbackContainer feedbackContainer)
	{
		...
		Object[] info =
		{ width, height, feedbackContainer };
