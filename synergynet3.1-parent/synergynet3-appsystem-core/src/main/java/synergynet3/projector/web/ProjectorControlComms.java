...
public class ProjectorControlComms {
	...
	public static ProjectorControlComms get() {
		synchronized(ProjectorControlComms.class) {
			if(instance == null) instance = new ProjectorControlComms();			
			return instance;
		}
	}
	...
	/**
	 * Get the number of all the devices connected to the network cluster of 'projector' type.
	 * 
	 * @return A float representing the number of devices connected to the network cluster of 'projector' type.
	 */
	 ...
	 * 
	 * @param message Indicator for whether content on all projectors should be cleared.
	 */
	 ...
	 * 
	 * @param message Indicator for whether content on specific projector should be cleared.
	 ...
	 * 
	 * @param message Indicator for whether content on all projectors should be aligned.
	 */
	...
	/**
	 * Send a message instigating the alignment of content on specific projector.
	 * 
	 * @param message Indicator for whether content on specific projector should be aligned.
	 * @param device ID on the network cluster of the device the message is to be sent to.
	 */
	...
	/**
	 * Send a message informing all projector devices to send their contents to a list of tables.
	 * 
	...
	/**
	 * Send a message informing a specific devices to send its contents to a list of tables.
	 * 
	 * @param tablesToSendTo List of the tables the contents are to be send to.
	 * @param device ID on the network cluster of the device the message is to be sent to.
	 */
	...
	/**
	 * Send a message informing a specific projector devices of contents to display.
	 * 
	 * @param message list of the content item representations being transfered.
	 * @param device ID on the network cluster of the device the message is to be sent to.
	 */
