...
import synergynet3.mediadetection.mediasearchtypes.*;
...
public class MediaDetection {
	...
	public enum SearchType{IMAGE, AUDIO, VIDEO, DOCUMENT, SLIDESHOW} 
	public enum Ordering{DATE_MODIFIED, ALPHABETICAL} 
	...
	/**
	* Adds a MediaSearchType which will set the file types this object's affiliated listener will search for.
	* This method can be called multiple times to set a range of file types to be searched for.
	*
	* @param searchType
	*          A predefined SearchType which the listener is needed to search for.
	**/
	...
	/**
	* Creates a custom search type using the extension.  The listener affiliated with this object will search for
	* any files which have the extension given.
	*
	* @param extension
	*          The extension of a file type the listener is needed to search for.
	**/
	...
	*          A user defined MediaSearchType which the listener is needed to search for.
	**/
	...
	*          A predefined ordering which sets the order any discovered files will be returned in.
	**/
	...
	/**
	* Sets how the maximum number of files should be returned by this object's listener at a time.
	*
	...
	*
	* @param directory
	*         The absolute path (and /name) of the directory to be check for new files.
	*         
	* @param mediaSearcher
	* 		  The object which any discovered files will be forwarded to.
	**/
	...
	* When discovered these devices will be searched for new File.  
	*         
	* @param mediaSearcher
	* 		  The object which any discovered files will be forwarded to.
	**/
	...
	/**
	* Sends any items already discovered by the in these locations to the tables.
	*         
	**/
	...
	/**
	* Creates a custom search type for use with initialising media discovery listeners.
	*
	* @param extension
	*         The extension of the file type this MediaSearchType should be used for finding.
	*         
	**/
	...
	/**
	* Creates a custom search type for use with initialising media discovery listeners and searching directories using
	* the static methods defined by this class.
	*
	* @param extensions
	*         An array of strings which represent the extensions of the file types this MediaSearchType should be 
	*         used for finding.
	*         
	**/
	...
	/**
	* Searches the directory at the given location for file types defined by the given MediaSearchTypes.
	*
	* @param directory
	*         The location and name of the directory to be searched for files.
	* @param mediaSearchTypes
	*         An array of user defined MediaSearchTypes which defines the file types being searched for.
	* @param numberToReturn
	*         The maximum number of files to be returned by this search.
	*         If value is not positive then all files discovered will be returned.
	* @param ordering
	*         A predefined ordering which sets the order any discovered files will be returned in.
	*         If value is null then the discovered files will be returned in order of data modified.
	*         
	**/
	public static File[] searchDirectory(String directory, MediaSearchType[] mediaSearchTypes, int numberToReturn, Ordering ordering){
		if (ordering == null){ordering = Ordering.DATE_MODIFIED;}
	...
	/**
	* Searches the directory at the given location for file types defined by the given MediaSearchType.
	*
	* @param directory
	*         The location and name of the directory to be searched for files.
	* @param mediaSearchTypes
	*         A MediaSearchType which defines the file types being searched for.
	* @param numberToReturn
	*         The maximum number of files to be returned by this search.
	*         If value is not positive then all files discovered will be returned.
	* @param ordering
	...
	**/
	...
	/**
	* Searches the directory at the given location for file types defined by the CustomSearchType
	* created from the given array of extensions.
	*
	* @param directory
	*         The location and name of the directory to be searched for files.
	* @param extensions
	*         An array of extensions used to define the file types being searched for.
	* @param numberToReturn
	*         The maximum number of files to be returned by this search.
	*         If value is not positive then all files discovered will be returned.
	* @param ordering
	...
	**/
	...
	/**
	* Searches the directory at the given location for file types defined by the CustomSearchType
	* created from the given extension.
	*
	* @param directory
	*         The location and name of the directory to be searched for files.
	* @param extension
	...
	*         The location and name of the directory to be searched for files.
	* @param searchType
	*          A predefined SearchType which determines the files types to be searched for.
	* @param numberToReturn
	*         The maximum number of files to be returned by this search.
	*         If value is not positive then all files discovered will be returned.
	* @param ordering
	...
	**/
	...
	private static MediaSearchType getSearchTypeTarget(SearchType searchType){
		switch (searchType){
			case IMAGE: return new ImageSearchType();
			case AUDIO: return new AudioSearchType();
			case VIDEO: return new VideoSearchType();
			case DOCUMENT: return new DocumentSearchType();
			case SLIDESHOW: return new SlideshowSearchType();
		}
