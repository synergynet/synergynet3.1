...
public interface IZOrderManager extends IItemListener {
	 ...
	 * @param defaultZOrderManager the default z order manager
	 */
	void notifyChildZCapacityChanged(IItem itemBeingManaged,
	 ...
	 *
	 * @param enabled the new auto bring to top
	 */
	 ...
	 *
	 * @param should the new bring to top propagates up
	 */
	 ...
	 *
	 * @param zValue the new item z order
	 */
