...
public interface IItem extends INestable {
	 ...
	 *
	 * @param b the new interaction enabled
	 */
	 ...
	 *
	 * @param itemListeners the new item listeners
	 */
	 ...
	 *
	 * @param loc the new relative location
	 */
	 ...
	 *
	 * @param angle the new relative rotation
	 */
