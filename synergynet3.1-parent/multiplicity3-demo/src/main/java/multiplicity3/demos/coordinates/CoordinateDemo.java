...
public class CoordinateDemo implements IMultiplicityApp {
	...
	public void shouldStart(MultiTouchInputComponent input, IQueueOwner iqo) {
		...
		try {
			IMutableLabel label_0_0 = cf.create(IMutableLabel.class, "lbl",
					UUID.randomUUID());
			label_0_0
			...
			IMutableLabel label_0_0l = cf.create(IMutableLabel.class, "lbl",
					UUID.randomUUID());
			label_0_0l
					.setFont("multiplicity3/demos/contentdemo/arial32_white.fnt");
			...
			IMutableLabel label_100_100 = cf.create(IMutableLabel.class, "lbl",
					UUID.randomUUID());
			label_100_100
					.setFont("multiplicity3/demos/contentdemo/arial32_white.fnt");
			...
			IMutableLabel label_100_100s = cf.create(IMutableLabel.class,
					"lbl", UUID.randomUUID());
			label_100_100s
					.setFont("multiplicity3/demos/contentdemo/arial32_white.fnt");
			...
			label_100_100s.setWorldLocation(stage.screenToWorld(new Vector2f(
					200, 200)));

			IMutableLabel label_1024_768s = cf.create(IMutableLabel.class,
					"lbl", UUID.randomUUID());
			label_1024_768s
					.setFont("multiplicity3/demos/contentdemo/arial32_white.fnt");
			...
			label_1024_768s.setWorldLocation(stage.screenToWorld(new Vector2f(
					900, 700)));

			IMutableLabel label_1_1_t = cf.create(IMutableLabel.class, "lbl",
					UUID.randomUUID());
			label_1_1_t
					.setFont("multiplicity3/demos/contentdemo/arial32_white.fnt");
			...
			label_1_1_t.setWorldLocation(stage.tableToWorld(new Vector2f(0.5f,
					0.95f)));

			IMutableLabel label_corner_w = cf.create(IMutableLabel.class,
					"lbl", UUID.randomUUID());
			label_corner_w
					.setFont("multiplicity3/demos/contentdemo/arial32_white.fnt");
			...
			final IMutableLabel cursorLabel = cf.create(IMutableLabel.class,
					"lbl", UUID.randomUUID());
			cursorLabel
					.setFont("multiplicity3/demos/contentdemo/arial32_white.fnt");
