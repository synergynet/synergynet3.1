...
public class TableCloneDisplaySynchronizer
{
	...
	/** The Constant log. */
	private static final Logger log = Logger.getLogger(TableCloneDisplaySynchronizer.class.getName());
	 ...
	 *            the device
	 */
	public TableCloneDisplaySynchronizer(final ProjectExpressionsUI projectExpressionsUI, ProjectorDevice device)
	{
		device.getTargetToShowControlVariable().registerChangeListener(new DistributedPropertyChangedAction<Double>()
		{
			@Override
		...
		device.getShouldUpdatePositionControlVariable().registerChangeListener(new DistributedPropertyChangedAction<Integer>()
		{
			@Override
		...
		device.getUnifyRotationControlVariable().registerChangeListener(new DistributedPropertyChangedAction<Boolean>()
		{
		...
		Boolean unifyRotation = device.getUnifyRotationControlVariable().getValue();
